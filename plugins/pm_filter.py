...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            InlineKeyboardButton(text="⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url=f"")
        ]
    )
    if 0 < offset <= 6:
        off_set = 0
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"😙Rᴇǫᴜᴇsᴛᴇᴅ Bʏ {message.from_user.mention} /n😊 Yᴏᴜʀ Qᴜᴇʀʏ {search} /n📂Tᴏᴛᴀʟ Fɪʟᴇs Fᴏᴜɴᴅᴇᴅ : {str(total_results)}"
